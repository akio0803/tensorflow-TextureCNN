...
def run_process(trial=trial_num):
    ...
    for cnt in range(trial):
        ...
        train_summary_writer = tf.train.SummaryWriter('output/scratch/{}/{}/train/'.format(today, cnt))
        test_summary_writer = tf.train.SummaryWriter('output/scratch/{}/{}/test/' .format(today, cnt))
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=True)) as sess:
            ...
            os.mkdir("model/scratch/{}/{}".format(today, cnt))
            saver.save(sess, "model/scratch/{}/{}/TCNN_scratch.ckpt".format(today, cnt))
...
if __name__ == '__main__':
    if os.path.exists("model/scratch/{}".format(today)) is False:
        os.makedirs("model/scratch/{}".format(today))

    result = run_process(trial=trial_num)

    with open("output/scratch/{}/result.pickle".format(today), "wb") as f:
